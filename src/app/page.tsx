...
const blogs = [
  {
    ...
    link: "https://medium.com/@prxshetty/deepseek-v3-mastery",
  ...
  },
  {
    ...
    link: "https://medium.com/@prxshetty/ai-benchmarks-analysis",
  ...
  },
  {
    ...
    link: "https://medium.com/@prxshetty/sql-to-graph-conversion",
    image: "/images/blogs/graph-db.webp",
    date: "Dec 4, 2024",
  },
  {
    ...
    link: "https://medium.com/@prxshetty/claude-computer-interaction",
    image: "/images/blogs/claude.webp",
    date: "Dec 3, 2024",
  },
  {
                      ...
                      <div className="bg-white rounded-lg overflow-hidden h-full flex flex-col">
                        <div className="relative">
                          ...
                          <div className="absolute bottom-2 right-2 flex gap-2">
                            <span className="bg-[#592be2]/10 text-[#592be2] px-2 py-1 rounded-full text-xs font-normal">
                              {blog.date}
                            </span>
                          </div>
                        </div>
