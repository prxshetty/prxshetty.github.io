...
function lb(a){var b={};b=G(b,"http_origin",document.URL);b=G(b,"user_agent",navigator.userAgent);b=G(b,"language",$a());b=G(b,"screen_width",screen.width||0);b=G(b,"screen_height",screen.height||0);b=G(b,"http_referrer",document.referrer);b=G(b,"browser_fingerprint_id",a.L);b=G(b,"developer_identity",a.m);b=G(b,"identity",a.m);b=G(b,"sdk","web");b=G(b,"sdk_version","2.86.2");b=mb(b,"model",y?y.model:"");return b=mb(b,"os_version",y?y.platformVersion:"")}
...
V.P=function(a,b,c,d,e,f){if(!tc){kc=c;fd(f);var m=d.audience_rule_id;(f=document.getElementById("branch-iframe-css"))&&f.parentElement.removeChild(f);var k=document.createElement("div");k.id="branch-banner";document.body.insertBefore(k,null);Rb(k,"branch-banner-is-active");var g=!1,u=b.callback_string,l=null,p=T.g;if(a){var q=Jc(a)||{};a=id(a);var Y=window.setTimeout(function(){window[u]=function(){}},qa);window[u]=function(n){window.clearTimeout(Y);g||(l=n,Yc(c,m,p,l,null,q,e))};jd(a,b.has_app_websdk,
function(n){Ac=n;null===n?g=!0:(Yc(c,m,p,l,n,q,e),ta&&(x["journey-load-time"]=(Date.now()-window.performance.timing.navigationStart).toString()),document.body.removeChild(k),z||e||V.ea(d))})}else document.body.removeChild(k),z||e||V.ea(d)}};
...
d.D)),null);if(0===d.A||!d.A)return g(Error(A("Branch SDK not initialized")),null)}m.unshift(g);b.apply(d,m)})}}function Z(){if(!(this instanceof Z))return kd||(kd=new Z),kd;this.ia=ec();this.g=new Fb;this.$=new Lb;this.u=[];this.ca="web2.86.2";this.l={};this.B=this.A=0;this.D=null}
